    ...
    <div class="row">
      ...
      <table class="table">
        ...
        <tr>
          ...
          <td width="85%">
            <input type=text name=subject size=20 class="input-sm" value="${vo.subject}" required>
          </td>
        </tr>
        <tr>
          <th width=15% class="text-center success">내용</th>
          <td width="85%">
            <textarea rows="10" cols="62" name=content value="${vo.content}" required></textarea>
          </td>
        </tr>
        <tr>
        ...
        <tr>
          <td colspan="2" class="text-center">
            <button class="btn-sm btn-danger" type=submit>수정완료</button>
